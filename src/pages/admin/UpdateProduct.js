          ...
          <div className="col-md-9">
            ...
            <div className="m-1 w-75">
              ...
              <div className="btn-group w-100" role="group" aria-label="Basic example">
                <button type="button" className="btn btn-success" onClick={handleUpdate} > <BiEdit /> </button>
                <button type="button" className="btn btn-danger" onClick={handleDelete} > <AiFillDelete /> </button>
              </div>
            </div>
          </div>
